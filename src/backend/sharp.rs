...
static mut DISP: OnceCell<
    Mutex<ThreadModeRawMutex, MemoryDisplay<Spim<'static, SPI2>, Output<'static, P0_03>, Output<'static, P0_02>>>
> = OnceCell::new();

static SIG: Signal<ThreadModeRawMutex, ()> = Signal::new();

pub async fn disp() -> MutexGuard<'static, ThreadModeRawMutex, MemoryDisplay<Spim<'static, SPI2>, Output<'static, P0_03>, Output<'static, P0_02>>> {
...
pub fn init_disp(spi: SPI2, sck: P0_14, mosi: P0_13, cs: P0_03, disp: P0_02, _: Size) {
    ...
    let spi: Spim<SPI2> = Spim::new_txonly(
        spi,
        irq,
        sck,
        mosi,
    ...
    unsafe { DISP.set(Mutex::new(display)).unwrap_unchecked(); }
}
